...
function ray_color(r, worldObj, depth) {
  ...
  if (worldObj.hit(r, 0, Number.MAX_SAFE_INTEGER, rec)) {
    ...
    // или не закончиться глубина преотражения.
    // 
    // При каждом преломлении луч теряет 0.5 от своей силы света,
    // так кааждый следуюший луч приносить в половину мешьще света чем превидуший
    // 
    // 
